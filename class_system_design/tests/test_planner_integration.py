...
"""
Some global variables, established to improve readability of tests.
"""
empty_planner = None
empty_diary = None
...
"""
A function that sets up/resets any global variables that might be useful for
testing the Diary-related classes, methods and attributes.
"""
def diary_setup():
...
"""
A function that sets up/resets any global variables that might be useful for
testing the TodoList-related classes, methods and attributes.
"""
def todolist_setup():
...
"""
Integrated test for Diary & Planner setup.
"""
def test_add_diary():
    diary_setup()
...
"""
Integrated tests for DiaryEntry, Diary & Planner setup.
"""
#test_add_diary_entry_wrong_type(): -> unit tested in in test_diary.py

#test_add_diary_entry_with_wrong_args(): -> unit tested in test_diary_entry.py
...
"""
Integrated tests for Contact, DiaryEntry, Diary & Planner setup.
"""
#test_add_contact_no_diary():

#test_add_contact_wrong_type(): -> unit tested in test_diary_entry.py

#test_add_contact_with_wrong_args(): -> unit tested in test_contact.py
...
"""
Integrated tests for Contact, DiaryEntry, Diary & Planner methods.
"""
#test_list_diary_entries_no_diary(): -> unit tested in test_diary.py
...
#test_read_diary_entry_by_title_no_diary(): -> unit tested in test_diary.py
...
#test_read_diary_entry_chunk_no_diary(): -> unit tested in test_diary.py
...
#test_read_entry_by_time_no_diary(): -> unit tested in test_diary.py
...
#test_list_contacts_no_diary(): -> unit tested in test_diary.py
...
"""
Integrated test for TodoList & Planner setup.
"""
#test_add_todolist_wrong_type(): -> unit tested in test_planner.py
...
"""
Integrated test for Todo, TodoList & Planner setup.
"""
#test_add_todo_no_todo_list(): -> unit tested in test_planner.py

#test_add_todo_wrong_type(): -> unit tested in test_todo_list.py

#test_add_todo_wrong_args(): -> unit tested in test_todo.py
...
"""
Integrated tests for Todo, TodoList & Planner methods.
"""
#test_give_up_all_tasks_no_todo_list(): -> unit tested in test_planner.py

#test_give_up_all_tasks_no_tasks(): -> unit tested in test_todo_list.py
...
#test_list_incomplete_tasks_no_todo_list(): -> unit tested in test_planner.py

#test_list_incomplete_tasks_no_tasks(): -> unit tested in test_todo_list.py
...
#test_mark_task_complete_no_todo_list(): -> unit tested in test_planner.py
